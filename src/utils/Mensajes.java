...
public class Mensajes {
    ...
    // CRUD
    public static final String PEDIR_NUEVOS_DATOS = "Ingrese los NUEVOS datos ";
    ...
    public static final String ERROR_LECTURA = "Error: No se pudo acceder al archivo de datos";
